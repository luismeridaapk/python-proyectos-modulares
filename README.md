...
| **MODULO 7** | `PROYECTO 1`<br>`PROYECTO 2` | • Persistencia I/O en `.txt` y exportación a `.json`<br>• Programación funcional (`filter`, `lambda`, *list comprehensions*)<br>• Manejo de excepciones y separación de responsabilidades (I/O, Analytics, Core) |
